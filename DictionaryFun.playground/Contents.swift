...
if let anotherCapital = anotherCapital {
    print ("The capitial of Pennsylvania is \(anotherCapital)")
} else {
 ...
 */
// write your code here
var pensCap = stateCapitals ["Pennsylvania"]

if let pensCap = pensCap {
    print ("Pennsylvania's capital is \(pensCap)")
}
...
let state = "New York"
// write your code here
if let nyCap = stateCapitals[state] {
...
var bandMembers = [ "Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
                    "The Beatles" : ["John Lennon", "Heroge Harrison", "Paule McCartney", "Ringo Star"],
                    "The Breeders" : ["Kim Deal", "Kelly Deal", "Josephine Wiggs", "Jim Macpherson"],
                    "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"]]
...
let bandName = "Pixies"
// write your code here
let listOfMembers = bandMembers [bandName]

if let listOfMembers = listOfMembers {
    print ("The band members of \(bandName) are:")
    for (index, member) in listOfMembers.enumerate() {
